...
namespace gnohp18.quiz.Migrations
{
    ...
    [Migration("20230614110803_CreateTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gnohp18.quiz.Answers.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("gnohp18.quiz.Players.Player", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("gnohp18.quiz.Questions.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("TypeOfQuestionId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("gnohp18.quiz.Results.Result", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("NumberOfFalseAnswer")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfTrueAnswer")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gnohp18.quiz.TypeOfQuestions.TypeOfQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("gnohp18.quiz.Answers.Answer", b =>
                {
                    b.HasOne("gnohp18.quiz.Questions.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("gnohp18.quiz.Questions.Question", b =>
                {
                    b.HasOne("gnohp18.quiz.TypeOfQuestions.TypeOfQuestion", "TypeOfQuestion")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("gnohp18.quiz.Results.Result", b =>
                {
                    b.HasOne("gnohp18.quiz.Players.Player", "Player")
                        .WithMany("Results")
